...
describe("DatePickers", () => {
  ...
  it("calls onStartDateChange with the correct value when a month is selected", async () => {
  ...
  it("calls onEndDateChange with the correct value when a month is selected", async () => {
